...
<head>
  ...
  <a href="#">My Pets</a>
   ...
   <a class="selected" href="reminders.php">Reminders</a>
  ...
  <a href="Index.php">Logout</a>
	  ...
	  <div align="center">
 	  <table width="613" height="50" border="0">
 	  	<tbody>
 	  		<tr>
				<td width="100"abbr="">Pet Name</td>
	  			<td width="100">Reminder Date</td>
	  			<td width="100">Reminder Time</td>
  	  ...
  	  <?php
			...
			$query = "SELECT * FROM reminders WHERE owner_id = '$ownerId'";
		  
		  	$result = mysqli_query($conn,$query);
		  
		  	while($row = mysqli_fetch_array($result)) {
				echo '<tr>';
				echo  '<td><input type="text" value="'.$row['pet_name'].'" name="txtName" id="txtName"></td>';
				echo  '<td><input type="text" value="'.$row['reminder_date'].'" name="txtBreed" id="txtBreed"></td>';
				echo  '<td><input type="text" value="'.$row['reminder_time'].'" name="txtDoB" id="txtDoB"></td>';
				echo  '<td><input type="text" value="'.$row['description'].'" name="txtGender" id="txtGender"></td>';
